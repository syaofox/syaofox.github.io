---
title: "Python 命令行之旅：fire 实现 git 命令"
date: 2022-01-07T14:44:10+08:00
description: ""
image: ""
categories: [Coding]
tags: [python,fire]
...
[gitpython](https://gitpython.readthedocs.io/en/stable/intro.html) 是一个和 `git` 仓库交互的 Python 第三方库。 我们将借用它的能力来实现真正的 `git` 逻辑。
